...
<!-- Mirrored from friday-theme.firebaseapp.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Oct 2019 21:17:04 GMT -->
                        ...
                        <div class="row row-masnory row-tb-20">
                            ...
                            <span class="t-uppercase" data-countdown="2019/09/01 01:30:00"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="{{asset('/frontend')}}/assets/images/brands/brand_01.jpg" alt="">
                                        </div>
                                    </figure>
                            ...
                            <span class="t-uppercase" data-countdown="2020/10/10 12:25:10"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="{{asset('/frontend')}}/assets/images/brands/brand_02.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <span class="t-uppercase" data-countdown="2020/10/10 12:25:10"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="{{asset('/frontend')}}/assets/images/brands/brand_03.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <span class="t-uppercase" data-countdown="2018/01/02 10:35:23"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="{{asset('/frontend')}}/assets/images/brands/brand_04.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <span class="t-uppercase" data-countdown="2021/12/03 03:15:00"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="{{asset('/frontend')}}/assets/images/brands/brand_05.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                            ...
                            <span class="t-uppercase" data-countdown="2019/10/10 12:00:00"></span>
                                        ...
                                        <div class="deal-store-logo">
                                            <img src="{{asset('/frontend')}}/assets/images/brands/brand_06.jpg" alt="">
                                        </div>
                                    </figure>
                                    <div class="bg-white pt-20 pl-20 pr-15">
                                        <div class="pr-md-10">
                        ...
                        <div class="popular-stores-slider owl-slider" data-loop="true" data-autoplay="true" data-smart-speed="1000" data-autoplay-timeout="10000" data-margin="20" data-items="2" data-xxs-items="2" data-xs-items="2" data-sm-items="3" data-md-items="5" data-lg-items="6">
                            ...
                            <div class="store-item t-center">
                                <a href="store_single_01.html" class="panel is-block">
                                    <div class="embed-responsive embed-responsive-4by3">
                                        <div class="store-logo">
                                            <img src="{{asset('/frontend')}}/assets/images/brands/brand_07.jpg" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="store-item t-center">
                                <a href="store_single_01.html" class="panel is-block">
                                    <div class="embed-responsive embed-responsive-4by3">
                                        <div class="store-logo">
                                            <img src="{{asset('/frontend')}}/assets/images/brands/brand_08.jpg" alt="">
                                        </div>
                                    </div>
                        ...
                        <div class="row row-tb-20">
                            <div class="footer-col col-sm-6">
                                <div class="footer-about">
                                    <img class="mb-40" src="{{asset('/frontend')}}/assets/images/logo_light.png" width="250" alt="">
                                ...
                                <div class="footer-top-instagram instagram-widget">
                                    ...
                                    <div class="row row-tb-5 row-rl-5">
                                        ...
                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="{{asset('/frontend')}}/assets/images/instagram/instagram_01.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="{{asset('/frontend')}}/assets/images/instagram/instagram_02.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="{{asset('/frontend')}}/assets/images/instagram/instagram_03.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="{{asset('/frontend')}}/assets/images/instagram/instagram_04.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="{{asset('/frontend')}}/assets/images/instagram/instagram_05.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="{{asset('/frontend')}}/assets/images/instagram/instagram_06.jpg" alt="">
                                        </div>
